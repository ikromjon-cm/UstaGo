...
DATABASES = {
    "default": env.db(
        "DATABASE_URL", default="postgres://postgres:postgres@localhost:5432/ustago"
    ),
}
...
if REDIS_AVAILABLE:
    ...
    CACHES = {
        "default": {
            ...
            "LOCATION": "ustago-local",
        },
        "session": {
            "BACKEND": "django.core.cache.backends.locmem.LocMemCache",
            "LOCATION": "ustago-session-local",
        },
    }
    CHANNEL_LAYERS = {
        "default": {
...
IS_TEST_ENV = "pytest" in sys.modules or any(
...
CONSTANCE_CONFIG = {
    ...
    "MASTER_VERIFICATION_REQUIRED": (
        True,
        "Require master identity verification",
        bool,
    ),
