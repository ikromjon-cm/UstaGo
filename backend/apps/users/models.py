...
class UserManager(DjangoUserManager):
    ...
    def _create_user(self, phone, password, **extra_fields):
        ...
        phone = str(phone)
        username = extra_fields.pop("username", "") or phone
        full_name = extra_fields.pop("full_name", "")
        user = self.model(
            phone=phone, username=username, full_name=full_name, **extra_fields
        )
...
class User(AbstractUser):
    ...
    device_id = models.CharField(
        max_length=255, blank=True, verbose_name=_("Device ID")
    )
    device_type = models.CharField(
        max_length=50, blank=True, verbose_name=_("Device Type")
    )
...
class MasterProfile(models.Model):
    ...
    categories = models.ManyToManyField(
        "categories.Category", related_name="masters", verbose_name=_("Categories")
    )
    experience = models.PositiveIntegerField(
        default=0, verbose_name=_("Experience (years)")
    )
    ...
    response_time = models.PositiveIntegerField(
        default=0, help_text=_("Average response time in minutes")
    )
    ...
    max_distance = models.PositiveIntegerField(
        default=50, help_text=_("Maximum travel distance in km")
    )
